...
//
// 
// accXangle = atan2(AcY,sqrt(AcX*AcX + AcZ*AcZ))*57.324;
// accYangle = atan2(AcX,sqrt(AcY*AcY + AcZ*AcZ))*57.324;
// acczangle = atan2(sqrt(AcX*AcX + AcY*AcY),AcZ)*57.324;/* my attempt to calculate yaw but not correct*/
// gyroXrate = GyX / 16.5;
// gyroYrate = GyY / 16.5;
// gyroZrate = GyZ/ 16.5;
//// Tmp=(Tmp/340+36.53);
